...
https://www.whaledu.com/group/4/thread/12?type=all&sort=desc
...
Traceback (most recent call last):
  File "/home/hello/Desktop/git-clone/qira/middleware/qira.py", line 104, in <module>
    qira_webserver.run_server(args, program)
  File "/home/hello/Desktop/git-clone/qira/middleware/qira_webserver.py", line 435, in run_server
    socketio.run(app, host=qira_config.HOST, port=qira_config.WEB_PORT, log=open("/dev/null", "w"))
  File "/home/hello/Desktop/git-clone/qira/venv/local/lib/python2.7/site-packages/flask_socketio/__init__.py", line 544, in run
    log=log, **kwargs)
...
```
Traceback (most recent call last):
  File "/home/hello/Desktop/git-clone/qira/middleware/qira.py", line 14, in <module>
    import qira_webserver
  File "/home/hello/Desktop/git-clone/qira/middleware/qira_webserver.py", line 41, in <module>
...
1、source {qira}/ven/bin/activate

 2、pip install flask_socketio，

from flask_socketio import SocketIO试一下，如果可以，将qira_webserver和qira_webstatic中的flask.ext.socketio修改成flask_socketio即可
